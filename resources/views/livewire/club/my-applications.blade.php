        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Управление заявками на лицензирование вашего клуба
                </p>
            </div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 mb-6">
                        ...
                        @else
                            @if($activeTab === 'pending')
                                У вас пока нет заявок ожидающих загрузки документов
                            @elseif($activeTab === 'in_review')
                                У вас пока нет заявок на проверке
                            @elseif($activeTab === 'completed')
                                У вас пока нет завершенных заявок
                            @else
                                У вас пока нет отмененных заявок
                            @endif
                        @endif
                    </p>
