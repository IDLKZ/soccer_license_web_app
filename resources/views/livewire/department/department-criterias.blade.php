<div>
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-2 text-gray-600 dark:text-gray-400">
                    Критерии заявок для проверки и рассмотрения
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <button wire:click="setActiveTab('revision')"
                class="{{ $activeTab === 'revision' ? 'ring-2 ring-orange-500 bg-orange-50 dark:bg-orange-900/20' : 'bg-white dark:bg-gray-800' }}
                       rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-6
                       hover:shadow-xl transition-all duration-300 text-left">
            <div class="flex items-center justify-between">
                <div>
