    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3">
            <div class="space-y-1">
                ...
                <a href="#" class="flex items-center px-4 py-3 text-gray-300 hover:bg-green-800 dark:hover:bg-green-800 hover:text-white rounded-lg transition-colors group">
                    <i class="fas fa-certificate w-5 text-center text-purple-400 group-hover:text-purple-300"></i>
                ...
                <a href="#" class="flex items-center px-4 py-3 text-gray-300 hover:bg-green-800 dark:hover:bg-green-800 hover:text-white rounded-lg transition-colors group">
                    <i class="fas fa-info-circle w-5 text-center text-indigo-400 group-hover:text-indigo-300"></i>
